...
loc_preds = "testsubmission_modified_huber_07042014.csv"
loc_submission = "submission_modified_huber_07042014.csv"
...
clf_svm = SGDClassifier(loss=loss, penalty='l1',shuffle=True,class_weight="auto")
...
pos_inds = y == 0
plt.hist(y_train[pos_inds,1],bins=30)
plt.show()
pos_inds = y == 1
plt.hist(y_train[pos_inds,1],bins=30)
plt.show()
