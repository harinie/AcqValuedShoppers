...
loc_preds = "testsubmission_randomforest_07042014.csv"
loc_submission = "submission_randomforest_07042014.csv"
...
tuned_parameters = [{'n_estimators': np.arange(10,20,10)}]
clf_svm = RandomForestClassifier(verbose=1)
...
#for e,x in enumerate(header):
		...
		#count += 1
		#continue
	#print(e,x,coef_svm[e-count])-0.16698782798019787)
